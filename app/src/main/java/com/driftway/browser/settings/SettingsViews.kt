package com.driftway.browser.settings
...
import com.driftway.browser.model.AppThemeMode
...
object SettingsViews {
    fun createSettingsContent(
        ...
        // TODO(owner): set to your own sponsor/donate URL for the Driftway relaunch.
        val sponsorUrl = "https://github.com/CreatorGhost/Driftway"
        ...
        adBlockInner.addView(
            buildSwitchRow(
                ...
                com.driftway.browser.adblock.AdBlockManager.setEnabled(context, isChecked)
            }
        )
        adBlockInner.addView(
            buildSwitchRow(
