...
import com.driftway.browser.analytics.UmamiTracker
...
import com.driftway.browser.data.BrowserPreferences
import com.driftway.browser.data.SiteIconCache
import com.driftway.browser.media.MediaSessionController
import com.driftway.browser.web.MediaPlaybackBridge
import com.driftway.browser.databinding.ActivityMainBinding
import com.driftway.browser.model.QuickActionButtonMode
import com.driftway.browser.model.QuickActionButtonPosition
import com.driftway.browser.model.UserAgentProfile
import com.driftway.browser.web.BrowserCallbacks
import com.driftway.browser.web.configureWebView
import com.driftway.browser.web.releaseCompletely
import com.driftway.browser.web.updateDesktopMode
import com.driftway.browser.web.updatePageDarkening
import com.driftway.browser.web.updateUserAgentProfile
...
import com.driftway.browser.settings.SettingsViews
...
class MainActivity : AppCompatActivity() {
    private data class BrowserTab(
        ...
        val speechBridge: com.driftway.browser.web.SpeechRecognitionBridge,
    ...
    private var latestReleaseUrl: String = "https://github.com/CreatorGhost/Driftway/releases"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupMediaSession()
        com.driftway.browser.adblock.AdBlockManager.initialize(this)
    ...
    private fun createBrowserTab(
        ...
        if (WebViewFeature.isFeatureSupported(WebViewFeature.WEB_MESSAGE_LISTENER)) {
            WebViewCompat.addWebMessageListener(
                tabView,
                com.driftway.browser.web.SpeechRecognitionBridge.BRIDGE_OBJECT_NAME,
                setOf("*")
    ...
    private fun ensureSettingsContentPopulated() {
        ...
        try {
            val contentView = SettingsViews.createSettingsContent(
                ...
                callbacks = com.driftway.browser.settings.SettingsCallbacks(
    ...
    private fun showCheckLatestView() {
        ...
        Thread {
            ...
            try {
                conn = (java.net.URL("https://api.github.com/repos/CreatorGhost/Driftway/releases/latest")
    ...
    companion object {
        ...
        // this neutral value avoids pointing at the original author's account.
        private const val START_PAGE_SPONSOR_URL = "https://github.com/CreatorGhost/Driftway"
