...
import com.driftway.browser.R
import com.driftway.browser.adblock.AdBlockManager
import com.driftway.browser.adblock.SponsorBlock
...
fun configureWebView(
    ...
    with(webView) {
        ...
        fun popupBlockOn(ctx: android.content.Context?): Boolean =
            ctx != null && com.driftway.browser.data.BrowserPreferences.isPopupBlockEnabled(ctx)
        ...
        webViewClient = object : WebViewClient() {
            ...
            override fun onPageStarted(view: WebView, url: String?, favicon: Bitmap?) {
                ...
                if (isHostOrSubdomainOf(host, "youtube.com") &&
                    com.driftway.browser.data.BrowserPreferences.isSponsorBlockEnabled(view.context)
                ) {
...
private fun handleCleartextIfNeeded(view: WebView, uri: Uri?, callbacks: BrowserCallbacks, onPageStart: Boolean = false): Boolean {
    ...
    if (com.driftway.browser.data.BrowserPreferences.isHostAllowedCleartext(view.context, host)) return false
    ...
    val allowHost = {
        view.context?.let { ctx ->
            ...
            if (hostToStore != null) com.driftway.browser.data.BrowserPreferences.addAllowedCleartextHost(ctx, hostToStore)
        }
        view.setTag(R.id.webview_allow_once_uri_tag, uri.toString())
        view.post { view.loadUrl(uri.toString()) }
        kotlin.Unit
